...
title: How to build Real World Event Sourced Applications
class: text-center
...
# How to build Real World Event Sourced Applications
...
Hsssssover on the bottom-left corner to see the navigation's controls panel, [learn more](https://sli.dev/guide/ui#navigation-bar)
